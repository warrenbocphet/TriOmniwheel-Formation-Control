...
void loop()
{
   ...
   if (elapsedTime1 > time_frame) // get IMU reading
   {
      ...
      {
        // kalman filter
      	filtered0 = KF_filter(0, gyroReading0);

        // converting unit
        speed0 = (filtered0/360.0)*1600.0; // from degree/s to step/s
      } 
      ...
      {
        // kalman filter
        filtered1 = KF_filter(1, gyroReading1);
      
        // converting unit
        speed1 = (filtered1/360.0)*1600.0; // from degree/s to step/s
      } 
      ...
      {
        // kalman filter
        filtered2 = KF_filter(2, gyroReading2);
    
        // converting unit
        speed2 = (filtered2/360.0)*1600.0; // from degree/s to step/s
      } 
